...
generalize (MfM.degree_bound m y H H1).
 ...
 rewrite H4 in |- *.
   ...
   unfold m1 in |- *.
   rewrite Mod.ndN_Tr in |- *.
   elim (le_lt_dec dy (ndN m)).
  elim 
 (eq_dart_dec y (Iter (MfM.f (Mod.Tr m x y)) dy y)).
    tauto.
  elim (eq_nat_dec dy (ndN m)).
   rewrite Iter_f_Tr_Id in |- *.
    unfold dy in |- *.
      rewrite MfM.degree_per in |- *.
      tauto.
